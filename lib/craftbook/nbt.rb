...
# tag = CraftBook::NBT.read_file('/code/cs/SharpNBT/SharpNBT.Tests/Data/bigtest.nbt')
# CraftBook::NBT.write_file("/home/eric/Desktop/test.nbt", tag, compression: :zlib)
# tag = CraftBook::NBT.read_file("/home/eric/Desktop/test.nbt")

# puts tag.stringify
# json = tag.to_json(true)
# puts json
#
# loaded = CraftBook::NBT::Tag.parse(json)
# require_relative 'nbt/snbt'
